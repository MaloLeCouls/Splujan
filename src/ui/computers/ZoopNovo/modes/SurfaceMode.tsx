...
export default function SurfaceMode({ state }: Props) {
  ...
  const modeStr = state.gas.o2Fraction > 0.209 ? 'NITROX' : 'AIR'
  ...
  return (
    <g>
      ...
      {/* Mode: AIR / NITROX / GAUGE / FREE */}
      <text x="124" y="130" textAnchor="middle" fontSize={modeStr.length > 3 ? 14 : 22} className="lcd-alpha">
        {modeStr}
      </text>
